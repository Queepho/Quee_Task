...
Path_Quee='/share/home/wangrui/Quee/'
partition='x86_64'
Details='source /share/opt/intel/2022.2.0/setvars.sh intel64'
Path_vasp='/share/home/wangrui/software/vasp.5.4.4/bin/vasp_std'
Path_python='python3'
	...
	then
		...
		then
				...
				then
					...
					./Quee_SR.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR.sh" > ./Q_____SR.slurm
				else
					...
					./Quee_SR.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR.sh" > ./Q_____SR.slurm
				fi
	...
	then
		...
		then
				...
				then
					...
					./Quee_SR_SCF.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF.sh" > ./Q_SR_SCF.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_SR_SCF.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF.sh" > ./Q_SR_SCF.slurm
				fi
	...
	then
		...
		then
				...
				then
					...
					./Quee_SR_SCF_BS.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF_BS.sh" > ./Q_R_F_BS.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_SR_SCF_BS.sh $CORE Quee_TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF_BS.sh" > ./Q_R_F_BS.slurm
				fi
	...
	then
		...
		then
				...
				then
					...
					./Quee_SR_SCF_BS_DOS.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF_BS_DOS.sh" > ./Q_R--DOS.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_SR_SCF_BS_DOS.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SR_SCF_BS_DOS.sh" > ./Q_R--DOS.slurm
				fi
	...
	then
		...
		then
				...
				then
					...
					./Quee_SCF.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SCF.sh" > ./Q____SCF.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_SCF.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_SCF.sh" > ./Q____SCF.slurm
	...
	then
		...
		then	
				...
				then
					...
					./Quee_BS.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_BS.sh" > ./Q_____BS.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_BS.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_BS.sh" > ./Q_____BS.slurm
				fi
	...
	then
		...
		then	
				...
				then
					...
					./Quee_DOS.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_DOS.sh" > ./Q____DOS.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_DOS.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_DOS.sh" > ./Q____DOS.slurm
				fi
	...
	then
		...
		then	
				...
				then
					...
					./Quee_BS_PNG.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_BS_PNG.sh" > ./Q__BSPNG.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_BS_PNG.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_BS_PNG.sh" > ./Q__BSPNG.slurm
				fi
	...
	then
		...
		then	
				...
				then
					...
					./Quee_LDOS_PNG.sh $CORE $TASK $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_LDOS_PNG.sh" > ./Q_DOSPNG.slurm
				else
					echo "未自定义任务名称，设为默认Quee_Task"
					...
					./Quee_LDOS_PNG.sh $CORE Quee_Task $Path_Quee $partition $Path_vasp $Path_python
					rm ./Quee_LDOS_PNG.sh" > ./Q_DOSPNG.slurm
				fi
